...
int osmo_sccp_tx_unitdata_ranap(struct osmo_sua_link *link,
...
int osmo_sccp_tx_conn_req(struct osmo_sua_link *link, uint32_t conn_id,
			  const struct osmo_sccp_addr *calling_addr,
			  const struct osmo_sccp_addr *called_addr,
			  uint8_t *data, unsigned int len)
{
...
int osmo_sccp_tx_conn_req_msg(struct osmo_sua_link *link, uint32_t conn_id,
			      const struct osmo_sccp_addr *calling_addr,
			      const struct osmo_sccp_addr *called_addr,
			      struct msgb *msg)
{
...
int osmo_sccp_tx_data(struct osmo_sua_link *link, uint32_t conn_id,
		      uint8_t *data, unsigned int len)
{
...
int osmo_sccp_tx_data_msg(struct osmo_sua_link *link, uint32_t conn_id,
			  struct msgb *msg)
{
	int rc;
